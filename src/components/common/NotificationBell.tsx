...
/**
 * Formata um timestamp ISO para texto relativo (ex.: "5min atrás").
 * Definida fora do componente para evitar a regra react-hooks/purity
 * (Date.now() é impuro e não pode ser chamado durante o render).
 */
