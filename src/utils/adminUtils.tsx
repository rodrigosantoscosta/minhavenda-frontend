...
export type OrderStatusType = 'CRIADO' | 'PAGO' | 'ENVIADO' | 'ENTREGUE' | 'CANCELADO'
...
export function EmptyState({ message = 'Nenhum item encontrado' }: { message?: string }): React.JSX.Element {
  return (
...
export function AdminCard({ children, className = '' }: { children: React.ReactNode, className?: string }): React.JSX.Element {
  return (
    <div
...
export function Tr({ children, onClick }: { children: React.ReactNode, onClick?: () => void }): React.JSX.Element {
  return (
    <tr
