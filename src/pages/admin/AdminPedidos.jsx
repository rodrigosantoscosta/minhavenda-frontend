        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {STATUSES.map(s => (
            <button
              ...
              className="px-3 py-1.5 rounded-lg text-xs font-medium transition-colors uppercase tracking-wider font-mono"
              style={{
                ...
                <tbody>
                  {pedidos.map(p => (
                    <Tr key={p.id}>
                      ...
                      <td className="px-5 py-3 text-sm font-medium font-mono text-white">{formatBRL(p.valorTotal)}</td>
